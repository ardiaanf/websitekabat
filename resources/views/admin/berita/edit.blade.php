                          ...
                          <form method="post" action="{{route('berita.update', $berita->id)}}" enctype="multipart/form-data">
                                ...
                                {{--$berita--}}
                                                ...
                                                <label for="" style="color: #686868;"  class="col-sm-7 col-form-label">Judul</label>
                                                    <input  type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ $berita->judul }}" id="example-text-input"  placeholder="Masukkan Judul">
                                                    @error('judul')
                                                ...
                                                <div class="form-grup mb-3">
                                                <label for=""  style="color: #686868;" class="col-sm-7 col-form-label ">Gambar</label>
                                             ...
                                             <!--       <div class="form-grup mb-3">
                                                <label for="" style="color: #686868;"  class="col-sm-7 col-form-label">-Judul Umkm</label>
                                                    <input  type="text" class="form-control @error('konten') is-invalid @enderror" name="deskripsi" value="" id="example-text-input"  placeholder="Masukkan Judul">
                                                    @error('konten')
                                                    <div class="invalid-feedback">
                                                    {{$message}}
                                                     </div>
                                             ...
                                             <div class="form-grup mb-3">
                                                ...
                                                <textarea type="text" id="summernote" class="form-control  @error('konten') is-invalid @enderror" name="konten">{{$berita->konten }}</textarea>
                                                @error('konten')
                                                    <div class="invalid-feedback">
                                                    {{$message}}
                                                     </div>
                                                ...
                                                <a class="btn btn-secondary" style=" width: 90px; height: 38px; font-size: 16px; border-radius: 4px; margin-top:15px; " href="{{ route('berita.view') }}"> Back</a>
