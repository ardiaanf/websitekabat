...
<h3 class="page-title">Edit Umkm</h1>
@endsection
                    ...
                    <div class="row">
                         <div class="col-12">
                                ...
                                <div class="card m-b-20">
                                 <div class="card-body">
                          <form method="post" action="{{route('umkm.update', $editData->id)}}" enctype="multipart/form-data">
                                @csrf
                                                <div class="form-grup mb-3">
                                                <label for="" style="color: #686868;"  class="col-sm-7 col-form-label">-Judul Umkm</label>
                                                    <input  type="text" class="form-control " name="judul" value="{{$editData->judul}}" id="example-text-input"  placeholder="Masukkan Judul">
                                                     </div>
                                                ...
                                                <div class="py-2">
                                                <img src="{{ asset('storage/umkm/gambar/' . $editData->gambar) }}" height="100" alt="">
                                                 </div>
                                             ...
                                             <div class="form-grup mb-3">
                                                ...
                                                <textarea type="text" id="summernote" class="form-control  " name="konten">{{$editData->konten }}</textarea>                                              
                                            </div>
