...
<h3 class="page-title">Tambah Umkm</h1>
@endsection
                         ...
                         <div class="col-12">
                          ...
                          <form method="post" action="{{route('umkm.store')}}" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <label for="" style="color: #686868;"  class="col-sm-7 col-form-label">-Nama Umkm</label>
                                                    <input  type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="" id="example-text-input"  placeholder="Masukkan Nama Umkm">
                                                    @error('judul')
                                             ...
                                             <div class="form-grup mb-3">
                                                ...
                                                <textarea type="text" id="summernote" class="form-control  @error('konten') is-invalid @enderror" name="konten"></textarea>
                                                @error('konten')
                                                    <div class="invalid-feedback">
                                                    {{$message}}
                                                     </div>
