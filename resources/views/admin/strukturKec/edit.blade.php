...
<h3 class="page-title">Edit Struktur Kecamatan</h1>
@endsection
                    ...
                    <div class="row">
                         <div class="col-12">
                                ...
                                <div class="card m-b-20">
                                 <div class="card-body">
                                 <form method="post" action="{{route('struKec.update', $editData->id)}}" enctype="multipart/form-data">
                                  @csrf     
                                                <div class="form-grup mb-3">
                                                <label for="" style="color: #686868;"  class="col-sm-7 col-form-label">-Nama</label>
                                                    <input  type="text" class="form-control" name="nama" value="{{$editData->nama }}" id="nama" placeholder="Masukkan Judul">
                                                </div>
                                                ...
                                                <div class="py-2">
                                                <img src="{{ asset('storage/strukturKec/foto/' .$editData->fotoProfil) }}" height="100" alt="">
                                                 </div>
